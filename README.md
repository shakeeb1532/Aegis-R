...
AWS, Okta, and Azure adapters support live ingestion using standard credentials (AWS chain, Okta token, Azure client credentials). GCP remains stubbed until credentials are wired in.
