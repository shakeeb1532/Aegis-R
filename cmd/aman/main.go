...
func usage() {
	...
	fmt.Println("  serve-api -addr :8081 -report data/report.json -audit data/audit.log -approvals data/approvals.log [-constraints data/constraints.json] [-feedback-out data/feedback.jsonl] [-tuning-audit-out data/tuning_audit.jsonl] [--require-key]")
